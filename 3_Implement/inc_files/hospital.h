/**
 * @hospital.h
 * @author Arti Yadav(https://github.com/arti0404/MyMiniProject.git)
...
void MainMenu(void)//function decleration
{
	...
	case 1:
      /**@brief about Add_rec function is called**/
	Add_rec();
    	break;
    case 2:
       /**@brief about list_rec function is called**/
    	func_list();
    	break;
	case 3:
       /**@brief about Search_rec function is called**/
	Search_rec();
    	break;
	case 4:
       /**@brief about edit_rec function is called**/
		Edit_rec();
		break;
	case 5:
       /**@brief about Dlt_rec function is called**/
		Dlt_rec();
		break;
	case 6:
       /**@brief about ex_it function is called**/
		ex_it();
    	break;
